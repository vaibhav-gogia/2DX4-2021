...
void PortL_Init(void){	//ext. LED
	...
	GPIO_PORTL_DEN_R = 0b00000001;
	GPIO_PORTL_DIR_R = 0b00000000;	//set PL5 as output (for ext. LED)
	return;
}
...
void backward(int delay){
	...
	GPIO_PORTE_DATA_R = 0b00001001; //1100
	SysTick_Wait1ms(delay);
	GPIO_PORTE_DATA_R = 0b00000011;// 0110
	SysTick_Wait1ms(delay);
	GPIO_PORTE_DATA_R = 0b00000110; //0011
	SysTick_Wait1ms(delay);
	GPIO_PORTE_DATA_R = 0b00001100;// 1001
	SysTick_Wait1ms(delay);
